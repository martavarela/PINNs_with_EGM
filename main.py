...
import paddle
import deepxde as dde  # Now try importing
#import torch
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model-folder-name', dest='model_folder_name', required = False, type = str,default = 'output_model', help='Folder name to save model (prefix /)')
...
def main(args):
    ...
    # print("GPU usage:", torch.cuda.memory_allocated() if torch.cuda.is_available() else "N/A")
